...
**قاعدة صارمة جداً - اللغة (مهم للغاية):**
- لا تترجم أي نص من العربية إلى أي لغة أخرى
- حافظ على اللغة الأصلية للنص كما هي في الملف بالضبط
...
- لا تغير أي كلمة أو مصطلح من اللغة الأصلية

**قاعدة تنسيق شرح الحل (answer_explanation):**
- عند استخراج شرح الحل أو طريقة الحل، حافظ على التنسيق الأصلي
- إذا كان الشرح على عدة أسطر، استخدم \\n للفصل بين الأسطر
- لا تضغط الشرح في سطر واحد - حافظ على الأسطر المنفصلة
- مثال: "الخطوة 1: ...\\nالخطوة 2: ...\\nالنتيجة: ..."

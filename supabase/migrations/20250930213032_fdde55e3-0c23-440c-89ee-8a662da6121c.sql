-- دالة لحساب وتحديث نقاط الطلاب بناءً على ما أنجزوه
...
BEGIN
  ...
  LOOP
    ...
    total_points := (lessons_completed * 2) + (videos_completed * 20) + (games_completed * 10);
...
-- تنفيذ الدالة لحساب النقاط للطلاب الحاليين

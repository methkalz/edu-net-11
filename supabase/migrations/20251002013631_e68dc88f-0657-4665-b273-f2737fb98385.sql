-- تحديث دالة get_student_dashboard_stats لاستخدام get_student_total_points لجميع الصفوف
...
BEGIN
  ...
  -- استخدام get_student_total_points لجميع الصفوف للحصول على النقاط الصحيحة

-- تحديث صلاحيات المعلمين لإدارة الصفوف في مدرستهم
DROP POLICY IF EXISTS "School admins can manage their school classes" ON public.classes;
DROP POLICY IF EXISTS "School admins can manage their school class names" ON public.class_names;
DROP POLICY IF EXISTS "School admins can manage class enrollments" ON public.class_students;
...
-- تحديث صلاحيات إدارة الطلاب للمعلمين

-- إصلاح دالة submit_exam_attempt لاستخدام questions_data عندما لا توجد أسئلة في exam_questions
...
BEGIN
  ...
  IF v_questions_from_table = 0 THEN
    ...
    LOOP
      ...
      -- جلب الإجابة الصحيحة من teacher_custom_questions (لأن source = 'teacher')

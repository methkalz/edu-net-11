-- حذف الـ triggers القديمة إن وجدت (للأمان)
...
-- إنشاء trigger لإنشاء إشعارات عند إضافة تعليق على مشاريع الصف الثاني عشر
...
-- إنشاء trigger لإنشاء إشعارات عند إضافة تعليق على مشاريع الصف العاشر

    ...
    <TooltipProvider>
      <div className="fixed bottom-6 right-6 z-50 w-[440px]">
        <div className="animate-slide-up-elegant opacity-0 scale-95 [animation-fill-mode:forwards] [animation-duration:600ms] [animation-timing-function:cubic-bezier(0.16,1,0.3,1)]">
          <Card className="shadow-2xl backdrop-blur-[40px] bg-white/[0.02] dark:bg-white/[0.01] border border-white/[0.08] dark:border-white/[0.05] rounded-3xl overflow-hidden transform transition-all duration-700 hover:shadow-3xl hover:bg-white/[0.04] dark:hover:bg-white/[0.02]">
            <CardHeader className="pb-4 space-y-4 bg-gradient-to-r from-white/[0.02] to-transparent backdrop-blur-[20px]">
              {/* Header العلوي */}
            ...
            <div className="relative animate-fade-in-delayed [animation-delay:200ms]">
              ...
              <Input
                ...
                className="pr-12 pl-12 h-12 backdrop-blur-[30px] bg-white/[0.03] dark:bg-white/[0.02] border border-white/[0.08] dark:border-white/[0.05] rounded-2xl text-foreground placeholder:text-muted-foreground/60 focus:border-primary/40 focus:bg-white/[0.06] dark:focus:bg-white/[0.04] transition-all duration-500 focus:scale-[1.02] focus:shadow-lg focus:shadow-primary/10"
              />
              {searchQuery && (
                  <Button
                    variant="ghost"
                    ...
                    className="absolute left-2 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 backdrop-blur-[20px] hover:bg-white/[0.06] dark:hover:bg-white/[0.04] rounded-xl transition-all duration-300 hover:scale-105 hover:rotate-90"
                  >
                  <X className="h-4 w-4" />
                </Button>
              )}
            ...
            <Collapsible open={showClassFilter} onOpenChange={setShowClassFilter}>
              <div className="flex items-center justify-between animate-fade-in-delayed [animation-delay:300ms]">
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" className="flex items-center gap-2 text-sm font-medium hover:bg-white/[0.03] dark:hover:bg-white/[0.02] backdrop-blur-[15px] transition-all duration-300 hover:scale-[1.02]">
              ...
              <CollapsibleContent className="mt-3 animate-accordion-down">
                <div className="flex flex-wrap gap-2">
                  {classes.map((classInfo, index) => (
                    <button
                      key={classInfo.id}
                      className={`group relative overflow-hidden rounded-xl px-3 py-2 text-xs font-medium transition-all duration-500 border backdrop-blur-[25px] animate-fade-in-delayed ${
                        selectedClasses.includes(classInfo.id)
                          ? 'bg-primary/[0.08] dark:bg-primary/[0.06] text-primary border-primary/[0.15] dark:border-primary/[0.12] shadow-lg shadow-primary/[0.03] scale-105'
                          : 'bg-white/[0.03] dark:bg-white/[0.02] text-muted-foreground border-white/[0.08] dark:border-white/[0.05] hover:bg-white/[0.06] dark:hover:bg-white/[0.04] hover:border-white/[0.12] dark:hover:border-white/[0.08] hover:text-foreground hover:scale-105'
                      }`}
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className={`px-1.5 py-0.5 rounded-md text-xs font-bold backdrop-blur-[15px] transition-all duration-300 ${
                          selectedClasses.includes(classInfo.id)
                            ? 'bg-primary/[0.15] dark:bg-primary/[0.12] text-primary'
                            : 'bg-white/[0.06] dark:bg-white/[0.04] text-muted-foreground/80'
                        }`}>
                      ...
                      {/* تأثير الـ hover */}
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-r from-transparent via-white/[0.02] to-transparent backdrop-blur-[10px]"></div>
                    </button>
                  ))}
                </div>
              </CollapsibleContent>

...
import { BookOpen, Video, FileText, Download, Eye, Edit3, Trash2, Plus, Calendar, User, BarChart3, TrendingUp, Target, Star, Trophy, CheckCircle } from 'lucide-react';
...
const Grade12Content: React.FC = () => {
  ...
  return <div className="container mx-auto px-6 py-8 space-y-8">
      {/* Header */}
      ...
      <Tabs defaultValue="final-projects" className="space-y-6">
        ...
        <TabsContent value="library" className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            {canManageContent && <Button onClick={() => setShowLibraryManager(true)} className="gap-2">
          ...
          <Card>
            ...
            <CardContent>
              {documents.length === 0 ? <div className="text-center py-8 text-muted-foreground">
                  ...
                  {documents.slice(0, 6).map(document => <div key={document.id} className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {format(new Date(document.created_at), 'dd MMM', {
                      locale: ar
                    })}
                        </p>
                      </div>
      ...
      {showLibraryManager && <FileLibraryManager onClose={handleCloseLibrary} />}
    </div>;
};

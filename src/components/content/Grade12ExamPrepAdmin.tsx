...
import { useGrade12ExamPrepAdmin, Grade12ExamPrepSectionWithTopics, Grade12ExamPrepTopicWithLessons, Grade12ExamPrepLessonWithMedia } from '@/hooks/useGrade12ExamPrepAdmin';
import Grade12ExamPrepSectionForm from './Grade12ExamPrepSectionForm';
import Grade12ExamPrepTopicForm from './Grade12ExamPrepTopicForm';
import Grade12ExamPrepLessonForm from './Grade12ExamPrepLessonForm';
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from '@/components/ui/alert-dialog';

const Grade12ExamPrepAdmin: React.FC = () => {
  const {
    sections,
    loading,
    saving,
    ...
    updateLesson,
    deleteLesson
  } = useGrade12ExamPrepAdmin();

  // Form states
  const [showSectionForm, setShowSectionForm] = useState(false);
  const [showTopicForm, setShowTopicForm] = useState(false);
  const [showLessonForm, setShowLessonForm] = useState(false);
  const [editingSection, setEditingSection] = useState<Grade12ExamPrepSectionWithTopics | null>(null);
  const [editingTopic, setEditingTopic] = useState<Grade12ExamPrepTopicWithLessons | null>(null);
  const [editingLesson, setEditingLesson] = useState<Grade12ExamPrepLessonWithMedia | null>(null);
  ...
  const handleEditSection = (section: Grade12ExamPrepSectionWithTopics) => {
  ...
  const handleEditTopic = (topic: Grade12ExamPrepTopicWithLessons) => {
  ...
  const handleEditLesson = (lesson: Grade12ExamPrepLessonWithMedia) => {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            إدارة المحتوى التحضيري لامتحان المشروع النهائي
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              ابدأ بإضافة قسم جديد لتنظيم المحتوى التحضيري
            </p>
...
export default Grade12ExamPrepAdmin;
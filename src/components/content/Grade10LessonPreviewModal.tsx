...
import { Grade10LessonWithMedia } from '@/hooks/useGrade10AdminContent';
import Grade10LessonContentDisplay from './Grade10LessonContentDisplay';

interface Grade10LessonPreviewModalProps {
  lesson: Grade10LessonWithMedia | null;
  isOpen: boolean;
  onClose: () => void;
}

const Grade10LessonPreviewModal: React.FC<Grade10LessonPreviewModalProps> = ({
  lesson,
  isOpen,
  onClose,
}) => {
...
export default Grade10LessonPreviewModal;

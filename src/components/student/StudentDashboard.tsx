          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 animate-fade-in-up animation-delay-200">
              ...
              <Card className="bg-white/10 backdrop-blur border-white/20 text-white relative overflow-hidden">
                <div className="absolute top-0 left-0 bg-gradient-to-r from-red-700 via-red-800 to-red-900 text-white px-16 py-1.5 text-xs font-bold whitespace-nowrap transform -rotate-[55deg] -translate-x-16 translate-y-7 shadow-lg z-10">

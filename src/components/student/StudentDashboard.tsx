          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 animate-fade-in-up animation-delay-200">
              ...
              <Card className="bg-white/10 backdrop-blur border-white/20 text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-destructive text-destructive-foreground px-10 py-1.5 text-xs font-bold whitespace-nowrap transform rotate-45 translate-x-5 translate-y-2 shadow-lg z-10">
                  طالب جديد
                </div>
                <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                  <UserTitleBadge 

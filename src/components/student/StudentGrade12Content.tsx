    ...
    <div className="container mx-auto px-6 py-12" dir="rtl">
      ...
      <div className="text-center space-y-6 mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
          محتوى الصف الثاني عشر التعليمي
        </h1>
          ...
          {filteredVideos.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground text-lg">
                {searchTerm 
                  ...
                  : 'سيتم إضافة الفيديوهات التعليمية قريباً'
                }
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredVideos.map((video) => (
                <Card key={video.id} className="group overflow-hidden hover:shadow-xl transition-all duration-500 border-0 bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-md hover:scale-[1.02] hover:-translate-y-1">

  ...
  public: {
    Tables: {
      ...
      exam_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "exam_questions_custom_question_id_fkey"
            columns: ["custom_question_id"]
            isOneToOne: false
            referencedRelation: "teacher_custom_questions"
            referencedColumns: ["id"]
          },
          {
      ...
      grade10_game_achievements: {
        ...
        Relationships: [
          {
            foreignKeyName: "grade10_game_achievements_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "grade10_player_profiles"
            referencedColumns: ["id"]
          },
        ]
      }
      grade10_game_progress: {
        Row: {
          attempts: number
          best_score: number
        ...
        Relationships: [
          {
            foreignKeyName: "grade10_game_progress_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "grade10_player_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grade10_game_progress_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "grade10_game_questions"
            referencedColumns: ["id"]
          },
        ]
      }
      grade10_game_questions: {
        Row: {
          choices: Json

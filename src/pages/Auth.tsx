    ...
    <div className="min-h-screen creative-background flex items-center justify-center p-6" dir="rtl">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.02]">
          ...
          <div className="absolute top-40 left-32 animate-float" style={{ animationDelay: '2s' }}>
            <Lock className="h-6 w-6 text-secondary" />
          </div>
          <div className="absolute bottom-32 right-40 animate-float" style={{ animationDelay: '4s' }}>
            <Users className="h-7 w-7 text-primary" />
          </div>
          <div className="absolute bottom-20 left-20 animate-float" style={{ animationDelay: '6s' }}>
